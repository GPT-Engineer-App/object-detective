...
const LiveFeed = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen p-4 pt-6 space-y-6">
      ...
      <div className="relative w-full max-w-md aspect-video mb-4">
        <video ref={videoRef} className="w-full h-full object-cover border rounded" autoPlay playsInline muted />
